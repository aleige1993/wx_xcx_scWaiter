...
Page({
    ...
    getList(type) {
        ...
        let parms = {
            ...
            type: type,
            page: _this.data.comser.page,
            page_size: _this.data.comser.pageSize
        }
    ...
    newTrend(e) {
        ...
        app.FormdataNewPHP.post('/user.info/recordPv', { content_id: contentId }, (res) => {
            if (res.code == '0000') {
                wx.navigateTo({
    ...
    onLoad: function (options) {
        ...
        let comserHeight = res.windowHeight - 130;
        let comserHeightCan = res.windowHeight - 45;
        this.setData({
            'boxHeight': boxHeight,
            'boxWidth': boxWidth,
            ...
            'comserHeight': comserHeight,
            'comserHeightCan': comserHeightCan
        });
