...
Page({
    ...
    goOrderDetails(e) {
        ...
        wx.navigateTo({
            url: '/pages/shopMall/orderDetails/details?orderno=' + orderno
        })
    },
    goOrderPeyMent(e) {
        wx.showLoading({
    ...
    getOrder() {
        ...
        app.FormdataPHP.get('/wxapp/orders/getList', query, (res) => {
            console.log(res);
            if (res.code == "0000") {
                this.setData({
    ...
    onLoad: function(options) {
        ...
        if (options.active) {
            this.setData({
                ...
                status: _this.data.statusArr[options.active]
            })
        }   
    },
